    ...
    focusTemplate.forEach(function(f) {
        ...
        if (fn.Properties.hasOwnProperty('Code') && fn.Properties.Code.hasOwnProperty('S3Bucket')) {
          ...
          if (! String(fn.Properties.Code.S3Bucket.Ref).startsWith('appcode')){
            fn.Properties.Code.S3Key = `%%SOLUTION_NAME%%/asset`+fn.Properties.Code.S3Key;
          ...
          fn.Properties.Content.S3Key = `%%SOLUTION_NAME%%/asset`+fn.Properties.Content.S3Key;
          ...
          fn.Properties.SourceObjectKeys = [`%%SOLUTION_NAME%%/asset`+fn.Properties.SourceObjectKeys[0]];
        ...
        // Set NestedStack S3 bucket reference
          ...
          fn.Properties.TemplateURL = {
            "Fn::Sub": "https://%%BUCKET_NAME%%-${AWS::Region}.s3.${AWS::URLSuffix}/%%SOLUTION_NAME%%/"+`${assetPath}`
          };
        }
